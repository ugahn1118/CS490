...
$insertExamQ1 = "INSERT INTO exam2(Name, Instructions, TestCases, Constraints, Difficulty, Topic, Points, Session)
VALUES ('".$row1['Name']."', '".$row1['Instructions']."', '".$row1['TestCases']."', '".$row1['Constraints']."', '".$row1['Difficulty']."', '".$row1['Topic']."', '".$points1."', '".$session."');";

$insertExamQ2 = "INSERT INTO exam2(Name, Instructions, TestCases, Constraints, Difficulty, Topic, Points, Session)
VALUES ('".$row2['Name']."', '".$row2['Instructions']."', '".$row2['TestCases']."', '".$row2['Constraints']."', '".$row2['Difficulty']."', '".$row2['Topic']."', '".$points2."', '".$session."');";

$insertExamQ3 = "INSERT INTO exam2(Name, Instructions, TestCases, Constraints, Difficulty, Topic, Points, Session)
VALUES ('".$row3['Name']."', '".$row3['Instructions']."', '".$row3['TestCases']."', '".$row3['Constraints']."', '".$row3['Difficulty']."', '".$row3['Topic']."', '".$points3."', '".$session."');";

$insertExamQ4 = "INSERT INTO exam2(Name, Instructions, TestCases, Constraints, Difficulty, Topic, Points, Session)
